...
def main():
    ...
    np.save(r"E:\Date\Teste\7_MDPI\Training image\GMM_5_DWT\Data_DWT_125.npy", inverse)
    ...
    cv2.imwrite(r"E:\Date\Teste\7_MDPI\Training image\GMM_5_DWT\GMM_DWT_125.TIF", segmented_image)
    ...
    np.save(r"E:\Date\Teste\7_MDPI\Training image\GMM_5_DWT\Labels_5_DWT_125.npy", labels)
    labels = cv2.resize(labels, (image.shape[0], image.shape[1]), interpolation=cv2.INTER_NEAREST)
    np.save(r"E:\Date\Teste\7_MDPI\Training image\GMM_5_DWT\Labels_5_DWT_125_resized.npy", labels)
